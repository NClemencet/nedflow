...
- Premature generalization (generics/interfaces with one impl)
- Config flags for behavior that could be a plain function argument

**Style drift**
- New code formats differently from neighboring code in the same file (indent, quotes, trailing comma)
...
- Do not flag the absence of tests (that is bug-hunter territory).
