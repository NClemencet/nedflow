...
**Injection**
- SQL: string interpolation into queries, missing parameterization
...
**Path / SSRF**
- User input joined to file paths without normalization / allowlist
...
- Do not comment on naming, duplication, or bugs that are not security.
